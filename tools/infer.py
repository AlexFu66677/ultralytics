...
model = YOLO(r"H:\G560_26s_9classs\weights/last.pt")
data = r"C:\Users\fjl\Desktop\240\val"
model.predict(data, save=True, imgsz=1280, conf=0.2,line_width = 1,half = True)
